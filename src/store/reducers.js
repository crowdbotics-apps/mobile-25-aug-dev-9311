...
export default function apiReducer(state = initialState, action) {
  switch (action.type) {
    ...
    case types.API_V1_GHFGHJGKJHG_LIST:
    case types.API_V1_GHFGHJGKJHG_LIST_SUCCEEDED:
    case types.API_V1_GHFGHJGKJHG_LIST_FAILED:
    case types.API_V1_GHFGHJGKJHG_CREATE:
    case types.API_V1_GHFGHJGKJHG_CREATE_SUCCEEDED:
    case types.API_V1_GHFGHJGKJHG_CREATE_FAILED:
    case types.API_V1_GHFGHJGKJHG_READ:
    case types.API_V1_GHFGHJGKJHG_READ_SUCCEEDED:
    case types.API_V1_GHFGHJGKJHG_READ_FAILED:
    case types.API_V1_GHFGHJGKJHG_UPDATE:
    case types.API_V1_GHFGHJGKJHG_UPDATE_SUCCEEDED:
    case types.API_V1_GHFGHJGKJHG_UPDATE_FAILED:
    case types.API_V1_GHFGHJGKJHG_PARTIAL_UPDATE:
    case types.API_V1_GHFGHJGKJHG_PARTIAL_UPDATE_SUCCEEDED:
    case types.API_V1_GHFGHJGKJHG_PARTIAL_UPDATE_FAILED:
    case types.API_V1_GHFGHJGKJHG_DELETE:
    case types.API_V1_GHFGHJGKJHG_DELETE_SUCCEEDED:
    case types.API_V1_GHFGHJGKJHG_DELETE_FAILED:
