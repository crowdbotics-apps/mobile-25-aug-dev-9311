...
export const api_v1_ghfghjgkjhg_list = () => ({
  type: types.API_V1_GHFGHJGKJHG_LIST
})
export const api_v1_ghfghjgkjhg_listSucceeded = response => ({
  type: types.API_V1_GHFGHJGKJHG_LIST_SUCCEEDED,
  response
})
export const api_v1_ghfghjgkjhg_listFailed = error => ({
  type: types.API_V1_GHFGHJGKJHG_LIST_FAILED,
  error
})
export const api_v1_ghfghjgkjhg_create = () => ({
  type: types.API_V1_GHFGHJGKJHG_CREATE
})
export const api_v1_ghfghjgkjhg_createSucceeded = response => ({
  type: types.API_V1_GHFGHJGKJHG_CREATE_SUCCEEDED,
  response
})
export const api_v1_ghfghjgkjhg_createFailed = error => ({
  type: types.API_V1_GHFGHJGKJHG_CREATE_FAILED,
  error
})
export const api_v1_ghfghjgkjhg_read = () => ({
  type: types.API_V1_GHFGHJGKJHG_READ
})
export const api_v1_ghfghjgkjhg_readSucceeded = response => ({
  type: types.API_V1_GHFGHJGKJHG_READ_SUCCEEDED,
  response
})
export const api_v1_ghfghjgkjhg_readFailed = error => ({
  type: types.API_V1_GHFGHJGKJHG_READ_FAILED,
  error
})
export const api_v1_ghfghjgkjhg_update = () => ({
  type: types.API_V1_GHFGHJGKJHG_UPDATE
})
export const api_v1_ghfghjgkjhg_updateSucceeded = response => ({
  type: types.API_V1_GHFGHJGKJHG_UPDATE_SUCCEEDED,
  response
})
export const api_v1_ghfghjgkjhg_updateFailed = error => ({
  type: types.API_V1_GHFGHJGKJHG_UPDATE_FAILED,
  error
})
export const api_v1_ghfghjgkjhg_partial_update = () => ({
  type: types.API_V1_GHFGHJGKJHG_PARTIAL_UPDATE
})
export const api_v1_ghfghjgkjhg_partial_updateSucceeded = response => ({
  type: types.API_V1_GHFGHJGKJHG_PARTIAL_UPDATE_SUCCEEDED,
  response
})
export const api_v1_ghfghjgkjhg_partial_updateFailed = error => ({
  type: types.API_V1_GHFGHJGKJHG_PARTIAL_UPDATE_FAILED,
  error
})
export const api_v1_ghfghjgkjhg_delete = () => ({
  type: types.API_V1_GHFGHJGKJHG_DELETE
})
export const api_v1_ghfghjgkjhg_deleteSucceeded = response => ({
  type: types.API_V1_GHFGHJGKJHG_DELETE_SUCCEEDED,
  response
})
export const api_v1_ghfghjgkjhg_deleteFailed = error => ({
  type: types.API_V1_GHFGHJGKJHG_DELETE_FAILED,
  error
})
